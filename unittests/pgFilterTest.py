...
class Test(unittest.TestCase):
    ...
    def testMinPeptide(self):
        ...
        self.assertEqual(FilterRequire1.filterORF(ORF0), 1) # 1 says DELETEME NOW
        self.assertEqual(FilterRequire1.filterORF(ORF1), 0) 
        self.assertEqual(FilterRequire5.filterORF(ORF2), 1) 
        self.assertEqual(FilterRequire2.filterORF(ORF2), 0) 
        self.assertEqual(FilterRequire5.filterORF(ORF5), 0) 
    ...
    def testUnique(self):
        ...
        self.assertEqual(Filter.filterORF(ORFHasUnique), 0)
        self.assertEqual(Filter.filterORF(ORFLacksUnique), 1)
    ...
    def testTrypticFilter(self):
        ...
        self.assertEqual(Filter.filterORF(ORFHasTryptic), 0)
        self.assertEqual(Filter.filterORF(ORFLacksTryptic), 1)
        self.assertEqual(Filter.filterORF(ORFUnset), 1)
